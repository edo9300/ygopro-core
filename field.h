...
public:
	...
	int32 check_release_list(uint8 playerid, int32 min, int32 max, int32 use_con, int32 use_hand, int32 fun, int32 exarg, card* exc, group* exg, uint8 check_field, uint8 to_player, uint8 zone, card* to_check);
