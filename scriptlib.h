...
public:
	...
	static int64 card_get_set_card(lua_State *L);
	static int64 card_get_origin_set_card(lua_State *L);
	static int64 card_get_pre_set_card(lua_State *L);
	static int64 card_get_fusion_set_card(lua_State *L);
