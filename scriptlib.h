...
public:
	...
	static int64 card_get_type(lua_State *L);
	static int64 card_get_origin_type(lua_State *L);
	...
	static int64 card_get_previous_type_onfield(lua_State *L);
	...
	static int64 card_is_type(lua_State *L);
