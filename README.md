...
### 5.) Build the system
If you are on windows using Visual Studio, and you used premake4, first right click on ` ygopro ` in the solution explorer, and then set it as startup project.
